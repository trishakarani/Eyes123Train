...
class ContrastTestViewController: UIViewController {
    ...
    var Instructions: String = "\r\n\r\nIn this test we test how you distinguish contrast in the colors. Keep the device at a safe distance from your eyes. You should choose the square box whose color contrasts in the picture.\r\n\r\n"
